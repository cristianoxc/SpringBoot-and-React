package com.cristianoxc.dsvendas.controllers;
...
import com.cristianoxc.dsvendas.services.SaleService;
...
public class SaleController {
	...
	public ResponseEntity<List<SaleSuccessDTO>> succesGroupdBySeller(){
		List<SaleSuccessDTO> list = service.succesGroupdBySeller();
		return ResponseEntity.ok(list);
	}
}
